  ...
  >
    ...
    <div v-show="!isLogin && !checkingLogin">
      <div style="line-height: 1.9">
        <p>
          👏 Introducing AI ChatGPT 3 - Turbo and DaVinci by OpenAI, your virtual assistant for tasks,
    ...
    <div>
      <div v-show="messages.length < 1 && isLogin && !checkingLogin" style="margin-bottom: 20px">
        <p> Abilities: </p>
        <ul>
          <li> Recalls previous statements made by the user during the conversation.</li>
          <li> Enables the user to make necessary modifications.</li>
        </ul>
        <p> Shortcomings: </p>
        <ul>
          <li> There is a possibility of generating inaccurate data</li>
          <li>
            May issue harmful directions or biased content.
          </li>
          <li> Limited knowledge of world and events after 2021</li>
        </ul>
        <p>
          🙌 The user can input commands to activate specific features
        </p>
        <div>
          <table>
            <tr>
      ...
      <div style="text-align: center" v-show="isLogin && !checkingLogin" aria-label="Settings">
        <div style="display: inline-block; position: relative">
          ...
          <button @click="logout" title="Sign out">
            <i class="iconfont" style="top: 2px" v-if="!showPageOptions">&#xe680;</i> Sign out
          </button>
